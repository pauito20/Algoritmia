...
class SudokuPS(PartialSolution):
    ...
    def successors(self) -> Iterable["SudokuPS"]:
        _,(row_vacia, col_vacia) = min((len(posibles_en(self.s,f, c)), (f,c)) for f,c in self.vacias)
        #El mínimo se puede obtener de forma tradicional
        ...
        vacias_hijo.remove((row_vacia, col_vacia))
...
if __name__ == "__main__":
    ...
    initial_ps = SudokuPS(m_sudoku, list(vacias(m_sudoku)))
